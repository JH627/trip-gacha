...
public class TripController {
	...
	public Response<?> bookmark(@RequestAttribute("userId") Integer userId, @Valid @RequestBody TripRequest.BookmarkSpot bookmarkSpot) {
	...
	public Response<?> registSpot(@RequestAttribute("userId") Integer userId, @Valid @ModelAttribute TripRequest.SpotRegistForm form) {
	...
	public Response<?> registSchedule(@RequestAttribute("userId") Integer userId, @Valid @RequestBody TripRequest.ScheduleRegistForm form) {
